...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.MyViewHolder> {
    ...
    public NewsAdapter(List<EventModel> moviesList, Activity ctx) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.newsitemlayout, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Picasso.with(ctx).load(Constants.NEWS_THUMBS_IMG_BASE_URL+movie.imagename).placeholder(R.drawable.circledefault).error(R.drawable.circledefault).into(holder.circleicon);

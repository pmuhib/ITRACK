...
public class Addindividual extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //    countrySpinner
        ((TextView)getActivity().findViewById(R.id.txt_heading)).setText("Add as Indiviual");
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (items[item].equals("Take Photo")) {
                            // if (result) {
                            if(PermissionRequestHandler.requestPermissionToCamera(getActivity(),Addindividual.this))
                            {
                                camFunction();
                            }
                            // }
                            ...
                            // if (result)
                            // {
                            if(PermissionRequestHandler.requestPermissionToGallary(getActivity(),Addindividual.this))
                            {
                                gallaryFun();
                            }
                            //  }

...
public class AddClientFragments extends Fragment {
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (items[item].equals("Take Photo")) {
                            // if (result) {
                            if(PermissionRequestHandler.requestPermissionToCamera(getActivity(),AddClientFragments.this))
                            {
                                camFunction();
                            }
                            // }
                            ...
                            // if (result)
                            // {
                            if(PermissionRequestHandler.requestPermissionToGallary(getActivity(),AddClientFragments.this))
                            {
                                gallaryFun();
                            }
                            //  }

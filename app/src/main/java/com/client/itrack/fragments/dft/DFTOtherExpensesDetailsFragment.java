 ...
 */
public class DFTOtherExpensesDetailsFragment extends BaseDFTFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view  = inflater.inflate(R.layout.dft_other_expenses_details_fragment,container,false) ;
    ...
    protected void setDateToView() {
        super.setDateToView();
        requestDFTOtherExpensesDetails(from_date,to_date,currency_code);
    }
    ...
    private void requestDFTOtherExpensesDetails(String from_date, String to_date, final String currency_code) {

        listPayments = new ArrayList<>();

        String url = Constants.BASE_URL+"other_expenses_details";
        ...
        HttpPostRequest.doPost(getActivity(), url, Utils.newGson().toJson(data), new HttpRequestCallback() {
            ...
            public void response(String errorMessage, String responseData) {
                ...
                try {
                    ...
                    if(status) {
                        ...
                        tvDFTCategoryTitle.setText("Total Amount : "+currency_code+" "+totalJObj.getString("otherexpenses"));
                    ...
                    Utility.sendReport(getActivity(),"other_expenses_details",status.toString(),Utils.newGson().toJson(data),responseData);
                }
                catch (Exception e){
                    e.printStackTrace();
                    Utility.sendReport(getActivity(),"other_expenses_details",e.getMessage(),Utils.newGson().toJson(data),responseData);
                }
            }
            ...
            public void onError(String errorMessage) {
                Utils.hideLoadingPopup();
                Utility.sendReport(getActivity(),"other_expenses_details","Error",Utils.newGson().toJson(data),errorMessage);
            }
        });
    }

...
public class DSRCargoDetailFragment extends Fragment {
    private static final int MAX_NUM_TRUCK = 20;
    ViewPager viewPager ;
    View view;
            ...
            public void response(String errorMessage, String responseData) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        String[] tabs = new String[MAX_NUM_TRUCK];
                        for (int indexTruckDetailObj = 0; indexTruckDetailObj < numberOfTrucks; indexTruckDetailObj++) {
                            ...
                            String border_charge_include=truckDetailObj.getString("border_charge_include");
                            ...
                            dsrTruckDetailModel.dest_currency_code = dest_currency_code;
                            ...
                            bundle.putCharSequence("detention_rate_client",detention_rate_client ); // [20-02-2017]
                            ...
                            bundle.putCharSequence("detention_client", detention_client); // [20-02-2017]
                            ...
                            modelTruckFinancialDetail.border_charge_include =  border_charge_include ;
                            /************ Changes *************/
                            ...
                            bundle.putCharSequence("border_charge_include",border_charge_include);
                            ...
                            tabhost.addTab(tabhost.newTabSpec(tag).setIndicator("Truck " + (indexTruckDetailObj + 1)),
                                    TruckDetailFragment.class, bundle);
    ...
    private void setUpTabHost() {
        ...
        try {
            ...
            tabhost.addTab(tabhost.newTabSpec("truck").setIndicator("Truck"),
                    TruckDetailFragment.class, null);
